...
console.log("OBS.: OS EXERCICIOS COMEÇAM NA LINHA 63"); //console só pra chamar atenção(mudar a cor) para essa observação
...
console.log("EXERCICIO 2 - CALCULADORA");
...
console.log("EXERCICIO 3 - PESO IDEAL");
...
console.log("EXERCICIO 4 - CLIENTE VIP");
...
console.log("EXERCICIO 5 - CALENDARIO");
...
console.log("EXERCICIO 6 - TAXA DE NATALIDADE");
...
// exercicio 7 - DESCONTO
console.log("EXERCICIO 7 - DESCONTO");
